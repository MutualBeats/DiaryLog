...
public class OrderBLService_Driver {
	public void drive (OrderBLService orderBLService){
		OrderVO vo1 = new OrderVO("1234567890123456", "1234567890", "WoDeMa", "12345678901", MemberType.Ordinary, OrderState.UnExcuted, "12345678", "和园宾馆", "3B346", RoomType.Single, 10000 ,1000, "2016/10/14", "2016/10/15", "2016/10/16", "2016/10/14", "2016/10/16", "2016/10/15");
		OrderVO vo2 = new OrderVO("1234567890123457", "1234567891", "WoDeTian", "98765432125", MemberType.Enterprise, null, "12345678", "和园宾馆", "3B347",RoomType.Double, 10000 ,-1000, "2016/10/14", "", "", "2016/10/14", "2016/10/16", "2016/10/14");
		OrderVO vo3 = new OrderVO("1234567890123458", "1234567891", "WoDeTian", "98765432125", MemberType.Enterprise, OrderState.Exception, "12345678", "和园宾馆", "3B347",RoomType.Double, 10000 ,-1000, "2016/10/17", "", "", "2016/10/17", "2016/10/19", "2016/10/17");
